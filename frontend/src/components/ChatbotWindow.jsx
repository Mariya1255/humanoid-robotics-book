...
const ChatbotWindow = ({ isOpen, onClose, sessionId: propSessionId, onSessionIdChange }) => {
  ...
  return (
    <div className="chatbot-window">
      ...
      {!isOpen && (
        <button
          className="chatbot-toggle chatbot-olive"
      ...
      {isOpen && (
        <div className="chatbot-container chatbot-olive">
          <div className="chatbot-header chatbot-olive">
            ...
            <div className="chat-messages">
              {messages.length === 0 ? (
                <div className="welcome-message">
                  ...
                  <p>Ask me about ROS 2, Digital Twin, NVIDIA Isaac, VLA, or Capstone projects.</p>
                </div>
              ) : (
